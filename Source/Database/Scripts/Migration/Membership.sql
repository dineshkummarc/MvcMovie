...
INSERT INTO [Roles] ([RoleName]) VALUES ('Administrator'),   ('Dev'),('Log'),('Audit'), ('Config')
GO
...
GO
INSERT INTO [RoleMemberships] ([UserName],[RoleName]) VALUES ('a','Administrator'),('a','Dev'), ('a','Log'),('a','Audit'),('a','Config'), ('b','Dev') , ('c','Config') , ('c','Log') 
GO
